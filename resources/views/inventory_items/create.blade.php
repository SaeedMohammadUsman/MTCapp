        ...
        <div class="card-body">
            <form action="{{ route('inventory_items.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="item_name_en" name="item_name_en" required>
                </div>
                <div class="form-group">
    ...
    <div class="card">
        ...
        @endif
            ...
            <form action="{{ route('inventory_items.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="item_name_en">Item Name (EN)</label>
                    <input type="text" class="form-control" id="item_name_en" name="item_name_en" value="{{ old('item_name_en') }}" required>
                    @error('item_name_en') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label for="item_name_fa">Item Name (FA)</label>
                    <input type="text" class="form-control" id="item_name_fa" name="item_name_fa" value="{{ old('item_name_fa') }}" required>
                </div>
                
                <div class="form-group">
                    <label for="item_code">Item Code</label>
                    <input type="text" class="form-control" id="item_code" name="item_code" value="{{ old('item_code') }}" required>
                    @error('item_code') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label for="cost_price">Cost Price</label>
                    <input type="number" class="form-control" id="cost_price" name="cost_price" value="{{ old('cost_price') }}" required>
                ...
                <div class="form-group">
                    <label for="quantity_in_stock">Quantity in Stock</label>
                    <input type="number" class="form-control" id="quantity_in_stock" name="quantity_in_stock" value="{{ old('quantity_in_stock') }}" required>
